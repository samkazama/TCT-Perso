...
@section('content')
	...
	<div class="form-group">
		...
		<div class="form-group">
			<input id="element_1" name="Titre" class="form-control" type="text" maxlength="255" value="{{$grade->Titre}}" required /> 
		</div> 

		<label for="Description">Description </label>
		<label for="Description" class="arabic-txt">العنوان</label>
		<div>
			<input id="element_10" name="Description" class="form-control" value="{{$grade->Description}}"></input> 
		</div> 
		<br>
