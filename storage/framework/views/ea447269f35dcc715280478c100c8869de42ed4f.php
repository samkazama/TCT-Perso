...
<?php $__env->startSection('content'); ?>
	...
	<div class="form-group">
				...
				<form method="post" action="/conges/<?php echo e($conge->id); ?>">
		...
		<div>
		<input value="<?php echo e($conge->Nom_emp); ?>" name="Nom_emp" class="form-control" disabled=""></input> 
		</div> 
		<br>			
		<div>			
		...
		<select class="form-control" name="Type"> 
			<option value="<?php echo e($conge->Type); ?>" selected="selected"><?php echo e($conge->Type); ?></option>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		...
		<div>
			<input value="<?php echo e($conge->Observation); ?>" name="Observation" class="form-control"></input> 
		</div> 
		<br>
		...
		<div>
			<input id="DUR" name="Duree" class="form-control" type="text" maxlength="255" value="<?php echo e($conge->Duree); ?>" required/> 
		</div> 
		<br>
		...
		<div>
			<input id="DD" name="Date_Debut" class="form-control" maxlength="255" value="<?php echo e($conge->Date_Debut); ?>" required/> 
		</div> 
		<br>
		...
		<div>
			<input id="DF" onclick="plusduree()" name="Date_Fin" class="form-control" maxlength="255" value="<?php echo e($conge->Date_Fin); ?>" required/> 
		</div> 
		<br>
		...
		<div>
			<input onfocus="skipweekend()" id="DR" name="Date_Retour" class="form-control" maxlength="255" value="<?php echo e($conge->Date_Retour); ?>" required/> 
		</div> 
		<br>
		...
		<select class="form-control" name="Livreur"> 
			<option value="<?php echo e($conge->Livreur); ?>" selected="selected"><?php echo e($conge->Livreur); ?></option>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		...
		<div>
			<input id="element_12" name="Date_Recu" class="form-control" type="date" maxlength="255" value="<?php echo e($conge->Date_Recu); ?>"/> 
		</div> 
		<br>		
		...
		<div class="form-group">
			<input id="element_1" name="Medecin" class="form-control" type="text" maxlength="255" value="<?php echo e($conge->Medecin); ?>"  /> 
		</div> 
		<br>
		...
		<div>
			<input id="element_12" name="Date_Visite" class="form-control" type="date" maxlength="255" value="<?php echo e($conge->Date_Visite); ?>"/> 
		</div> 
		<br>
		...
		<div>
			<input value="<?php echo e($conge->Adresse_medecin); ?>" name="Adresse_medecin" class="form-control"></input> 
		</div> 
		<br>
